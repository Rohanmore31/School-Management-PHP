...
<body>
	<div id="header"><br>
		<center>Student Management System &nbsp;&nbsp;&nbsp;Teacher Panel
	...
	<div id="left_side">
		...
		<form action="" method="post">
			<table>
				<tr>
					<td>
						<input type="submit" style="width: 100%" class="btn btn-outline-primary showTable" name="search_student" value="Search Student"><br></br>
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit"   style="width: 100%" class="btn btn-outline-warning" name="edit_student" value="Edit Student"><br></br>
					</td>
				</tr>
				<tr>
					<td>
				...
				<tr>
					<td>
						<input type="submit"  style="width: 100%" class="btn btn-outline-dark" name="show teacher" value="Show Teachers"><br></br>
					</td>
				</tr>
				<tr>
					<td>
						<input type="submit"  style="width: 100%" class="btn btn-outline-info" name="subject_master" value="Subject Master"><br></br>
					</td>
				</tr>
			</table>
		</form>
...
?>
			...
			<?php
				if(isset($_POST['search_student']))
				{
					...
					<center>
					<form action="" method="post">
					&nbsp;&nbsp;<b>For Searching Enter Roll No:</b>&nbsp;&nbsp; <input type="text" name="roll_no">
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" value="<?php echo $row['teacher']?>" disabled>
								</td>
							</tr>
							<tr>
								<td>
					...
					while ($row = mysqli_fetch_assoc($query_run)) 
					{
						...
						<table style="border-collapse: collapse;border: 1px solid black;">
							<tr>
								...
								<td id="td"><?php echo $row['subjects']?></td>
							</tr>
						</table>
